...
const Landing = () => {
  const features = [
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1504868584819-f8e8b4b6d7e3?w=400&h=300&fit=crop&crop=center'
    },
    {
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1543286386-713bdd548da4?w=400&h=300&fit=crop&crop=center'
    },
    {
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1541701494587-cb58502866ab?w=400&h=300&fit=crop&crop=center'
    }
  ];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <div
                key={index}
                className="group relative p-8 bg-white rounded-3xl border-2 border-gray-100 hover:border-gray-200 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 overflow-hidden"
              >
                {/* Feature Image */}
